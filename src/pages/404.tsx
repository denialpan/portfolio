...
export function NotFound() {
    ...
    return (
        <div style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)" }}>
            ...
            <p style={{ fontFamily: "JetBrainsMono", textAlign: "center" }}>
                originally didnt know gh pages implemented their own 404
            </p>

            <h3 style={{ fontFamily: "JetBrainsMono", textAlign: "center", cursor: "pointer" }} onClick={() => window.location.href = "/portfolio/"} >
                back to home
            </h3>
